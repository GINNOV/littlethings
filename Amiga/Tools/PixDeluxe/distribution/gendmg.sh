...
usage() {
    ...
    echo "Example:"
    echo "  ./gendmg.sh --readme dmg_assets/README.md --app ~/Downloads/PixDeluxe/PixDeluxe.app --dmg ../../releases/PixDeluxe.dmg --background dmg_assets/dmg-background.png --volicon dmg_assets/dmg-icon.icns"
...
# Modify DMG_PATH to include version and build number (e.g., PixDeluxe-1.0_387.dmg)
