	; Raw MOD playback benchmark using the ProTracker 2.3A routine.
	; The replay state is painted into three visible bitplane bars so the
	; benchmark can distinguish advancing playback from a static control.
