...
# Default parameters
APP_PATH="$HOME/Downloads/AuDeluxe.app"
DMG_PATH="$HOME/Downloads/AuDeluxe.dmg" # Will be modified with version and build
README_PATH=""
...
usage() {
    ...
    echo "Example:"
    echo " all details: ./gendmg.sh --readme dmg_assets/README.md --app ~/Downloads/AuDeluxe/AuDeluxe.app --dmg ../../releases/AuDeluxe.dmg --background dmg_assets/dmg-background.png --volicon dmg_assets/dmg-icon.icns"
...
# Modify DMG_PATH to include version and build number (e.g., AuDeluxe-1.0_387.dmg)
