...
# Default parameters
APP_PATH="$HOME/Downloads/IFFViewer.app"
DMG_PATH="$HOME/Downloads/IFFViewer.dmg" # Will be modified with version and build
README_PATH=""
...
usage() {
    ...
    echo "Example:"
    echo " all details: ./gendmg.sh --readme dmg_assets/README.md --app ~/Downloads/IFFViewer/IFFViewer.app --dmg ../../releases/IFFViewer.dmg --background dmg_assets/dmg-background.png --volicon dmg_assets/dmg-icon.icns"
    echo " 👉🏻 shortcut: ./gendmg.sh --readme dmg_assets/README.md"
    exit 1
}
...
# Modify DMG_PATH to include version and build number (e.g., IFFViewer-1.0_387.dmg)
