...
#ifdef PARANOID
	default:
	debug_printf("unknown case in general_implications 0\n");
	goto end_gen;
#endif PARANOID
	}
...
#ifdef PARANOID
			default:
				debug_printf("unknown case in general_implications 1\n");
				goto end_gen;
#endif PARANOID
...
#ifdef PARANOID
			default:
				debug_printf("unknown case in general_implications 2\n");
				goto end_gen;
#endif PARANOID
			}
			break;
...
#ifdef PARANOID
			default:
				debug_printf("unknown case in general_implications 3\n");
				goto end_gen;
#endif PARANOID
			}
			break;
