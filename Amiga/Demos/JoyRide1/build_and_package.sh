...
vasm -m68000 -Fhunkexe -I/opt/vbcc/sdk/NDK_3.9/Include/include_i -o "${BASENAME}.exe" "$ASM_FILE"
...
joystick_0_button_4 = action_joy_1_autofire_button
clipboard_sharing = 1
kickstart_file = ~/Documents/FS-UAE/Kickstarts/Kickstart ROM Set/Kickstart 3.1.rom
EOF
...
if [[ "$ANSWER" =~ ^[Yy]$ ]]; then
    ...
    # fs-uae joystickdemo.fs-uae --amiga-whdload=joystickdemo.exe
else
