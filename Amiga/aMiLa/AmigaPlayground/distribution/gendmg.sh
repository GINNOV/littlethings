...
# Default parameters
APP_PATH="$HOME/Downloads/Amiga Playground.app"
DMG_PATH="$HOME/Downloads/AmigaPlayground.dmg" # Will be modified with version and build
README_PATH=""
...
usage() {
    ...
    echo "Example:"
    echo "  ./gendmg.sh --readme dmg_assets/README.md --app ~/Downloads/AmigaPlayground/Amiga\\ Playground.app --dmg ../../releases/AmigaPlayground.dmg --background dmg_assets/dmg-background.png --volicon dmg_assets/dmg-icon.icns"
    echo " 👉_ shortcut: ./gendmg.sh --readme dmg_assets/README.md"
    exit 1
}
...
# Modify DMG_PATH to include version and build number (e.g., AmigaPlayground-1.0.0_37.dmg)
