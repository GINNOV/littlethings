...
CONST TEXT version[]="$VER: IRAPost V"VERSION"."REVISION" ("__DATE__")  (c)1993,94 Tim Ruehsen\n\n";
...
STATIC TEXT   buffer[BUFFERLENGTH];
STATIC TEXT   sourcename[80], destname[80], incname[80], FDname[80], libname[80];
STATIC FILE  *sourcefile, *destfile, *incfile, *FDfile;
STATIC STRPTR buffpeek;
STATIC int    swapcount, diffcount;
STATIC char **LibCallNames;
STATIC int   *LibCallFlags;
STATIC int   *LibCallOffs;
STATIC int    LIB_CALLS;
STATIC TEXT   BaseName[80];
STATIC int    firstbias, bias;
...
void ReadFD(void)
{
int publics, functions, publicflag, len = len, i;
