/*
	...
	Public Domain.
		...
		Program zapisuje pliki binarne w formie liczb hexadecymalnych (np. dla
	úródîówki w asemblerze). Kod lekko zmieniony w porównaniu do Bin2C.
...
// wersja programu
const static char Version[]="\0$VER: Bin2Asm 0.5 (" __DATE__ ") by LeMUr/Fire & blabla\0";
