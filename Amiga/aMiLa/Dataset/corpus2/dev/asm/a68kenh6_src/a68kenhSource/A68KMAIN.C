...
char *Version = "3.05 (April 27, 1998)";
...
/* *** NEW *** */
	fprintf (stderr, "Some 68020+ instructions added by Willi Kusche\n\n");
...
/* *** NEW *** */
	printf ("Some 68020+ instructions added by Willi Kusche\n\n");
	printf ("Assembling %s\n\n", SourceFN);
    }
...
/* *** NEW *** */
	xputs (&List, "Some 68020+ instructions added by Willi Kusche\n\n");
	LnCnt += 4;
    }
