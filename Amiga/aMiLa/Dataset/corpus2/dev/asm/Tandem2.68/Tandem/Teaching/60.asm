...
strings: dc.b 0
 ...
 dc.b 'Font Jam1 Case Styb Fixt Cspc Maxj Shrt Revs',0 ;2
 ...
 dc.b 0 ;55
 dc.b '3. "Revs" (reverse) allows right-to-left typing. Presumably,',0 ;56
 dc.b '   you''d also press Ctlr/r for right justify. n.b. reverse',0 ;57
 dc.b '   does not allow horizontal scrolling. It is not guaranteed',0 ;58
 dc.b '   to be compatible with all possible combinations of tags.',0 ;59
...
Pr_revs:
 ...
 move.l d0,revs
 bpl Pr_edit
 move.l #500,wdth          ;(forbid horz scrolling if revs)
 bra Pr_edit
