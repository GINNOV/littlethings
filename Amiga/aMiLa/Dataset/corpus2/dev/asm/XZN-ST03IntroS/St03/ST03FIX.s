******************************************************************************
*    	INTRO SHOWTIME 3 FIXED VERSION SBLINDO A DESTRA BY MODEM/X-ZONE	     *
*    		ORA PROVIAMO A FIXARLA QUI AL TIG,SPEREM...		     *
******************************************************************************
...
*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*
	...
	move.l	#COPVUOTO,$80(a5)	; Puntiamo la nostra 1a COP
...
POINTBPa:
	...
	move.l	#COPLIST3,$80(a5)	; Puntiamo la nostra 1a COP
	move.w	d0,$88(a5)		; Facciamo partire la 1a COP
...
*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*
	...
	lea 	BPLCREDITS,a1	; Indirizzo Puntatori in a1
	move.l	#VUOTO,d0	; Indirizzo Bitplanes in d0
	...
	move.l	#COPCREDITS,$80(a5)	; Puntiamo la nostra 1a COP
	move.w	d0,$88(a5)		; Facciamo partire la 1a COP
...
POINTBPb:
	...
	move.l	#COPLIST5,$80(a5)	; Puntiamo la nostra 1a COP
	move.w	d0,$88(a5)		; Facciamo partire la 1a COP
...
PALETTEPIC:
	dc.l	$00000000,$002e182b,$003d213d,$00472b4c,$0050355b,$0058416a
	dc.l	$005f4d79,$00675987,$006e6796,$007474a4,$008188b3,$00919ec2
	dc.l	$00a1b5d1,$00b1cbe0,$00c2e1ef,$00d7f9ff,$002e1109,$003c120c
	dc.l	$004a1512,$00571a1a,$00652329,$00732d3a,$0080394b,$008d455d
	dc.l	$009a5370,$00a86383,$00b67497,$00c384ab,$00d198c0,$00dfaed4
	dc.l	$00ecc3e6,$00fadaf8,$00552b26,$007d4a41,$00a47163,$00cc9b8a
	dc.l	$00f4cbb7,$00432111,$0057381f,$006c5231,$00806f48,$00948c62
	dc.l	$00a8a880,$00babda3,$00cfd1c9,$00291e1e,$0041302d,$0059433b
	dc.l	$00705847,$00877052,$009f8b5b,$00b7aa63,$00cecd69,$00d7e66d
	dc.l	$00daff71,$00252657,$00333669,$0044487b,$00575b8c,$006c739f
	dc.l	$00828ab1,$009ba3c3,$00b7bed5,$00d7dbe9
	cnop	0,8
...
COLP0B:
	...
	dc.w	$5007,$fffe,$102,$11
	dc.w	$5107,$fffe,$102,$00
	dc.w	$5207,$fffe,$102,$11
	dc.w	$5307,$fffe,$102,$00
	dc.w	$5407,$fffe,$102,$11
	dc.w	$5507,$fffe,$102,$00
	dc.w	$5607,$fffe,$102,$11
	dc.w	$5707,$fffe,$102,$00
	dc.w	$5807,$fffe,$102,$11
	dc.w	$5907,$fffe,$102,$00
	dc.w	$5a07,$fffe,$102,$11
	dc.w	$5b07,$fffe,$102,$00
	dc.w	$5c07,$fffe,$102,$11
	dc.w	$5d07,$fffe,$102,$00
	dc.w	$5e07,$fffe,$102,$11
	dc.w	$5f07,$fffe,$102,$00
	dc.w	$6007,$fffe,$102,$11
	dc.w	$6107,$fffe,$102,$00
	dc.w	$6207,$fffe,$102,$11
	dc.w	$6307,$fffe,$102,$00
	dc.w	$6407,$fffe,$102,$11
	dc.w	$6507,$fffe,$102,$00
	dc.w	$6607,$fffe,$102,$11
	dc.w	$6707,$fffe,$102,$00
	dc.w	$6807,$fffe,$102,$11
	dc.w	$6907,$fffe,$102,$00
	dc.w	$6a07,$fffe,$102,$11
	dc.w	$6b07,$fffe,$102,$00
	dc.w	$6c07,$fffe,$102,$11
	dc.w	$6d07,$fffe,$102,$00
	dc.w	$6e07,$fffe,$102,$11
	dc.w	$6f07,$fffe,$102,$00
