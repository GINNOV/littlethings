...
Asm_comm	dc.b		'ram:source.s -iWorkdisk:include -d',0
...
AsmMemName	dc.b		'ram:source',0
		EVEN
A68k_name	dc.b		'Workdisk:c/A68k',0
Blink_name	dc.b		'Workdisk:c/Blink',0
		EVEN
...
mb_msg		dc.b		$9b,"7;31;40m"
		dc.b		$0a,' ACC Message: PRESS LEFT MOUSE BUTTON TO CONTINUE.'
		dc.b		$9b,"0;31;40m"
mb_len		equ		*-mb_msg
		even
*****************************************************************************
...
max_num_chars	rs.l		1		num of chars on a line
...
offset		rs.l		1		window offset fo cur line
