...
; Test interrupt driven font routine
...
Level3		lea		$dff000,a5

		move.l		TextPos,a0
		bsr		WriteText
		move.l		a0,TextPos

		move.w		INTREQR(a5),d0		get request bits
		and.w		#VERTB!COPER!BLIT,d0	mask ones we need
		move.w		d0,INTREQ(a5)		clear interrupt
		
		rte					exit Supervisor

TextPos		dc.l		TestText

Font2		include		Source:M.Meany/Gfx/font8_2.i

TestText	dc.b		FSTRING			string printing
		dc.b		FFONT,1			font 1
		...
		dc.b		FSINGLE			char printing
		dc.b		FCOLOUR,12		colour 12
		dc.b		FCENTER			centralise
		...
		dc.b		FMODE,SPLAT		AND draw mode
		dc.b		FCENTER			centralise
		dc.b		'back to the drawing board !!!'
...
bitplane	dcb.b		40*256*4,$ff	40 bytes wide by 256 lines
