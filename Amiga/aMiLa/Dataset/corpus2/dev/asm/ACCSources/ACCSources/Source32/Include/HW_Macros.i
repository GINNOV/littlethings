...
; M.Meany, Sept 1992.
		...
		LIST
;*** Macros.i v1.01, by M.Meany ***
		NOLIST

; v1.01		Tidied code and made SETVERTB accept absolute address as
;		suggested by Mr. R. Haylock, Exeter.
...
QBLITTER	macro
QBlit\@		btst.b		#6,$dff002
		bne.s		QBlit\@
		endm

; Set and start a level 3 interrupt

SETVERTB	macro		absolute address
