...
Main		move.l		#Bob,BLTAPTH(a5)	source address
		move.l		#Screen,BLTDPTH(a5)	destination address
		move.w		#0,BLTAMOD(a5)		bob modulo
		move.w		#ScrnWidth-2,BLTDMOD(a5) screen modulo
		move.l		#-1,BLTAFWM(a5)		no masking
		move.w		#$09f0,BLTCON0(a5)	use A&D, D=A
		move.w		#0,BLTCON1(a5)		clear this
		move.w		#72<<6!1,BLTSIZE(a5)	start blit
