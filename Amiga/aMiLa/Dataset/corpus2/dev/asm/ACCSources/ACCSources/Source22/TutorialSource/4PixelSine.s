...
* -------------	Single buffered 4 Pixel sine scroller -----------------	*
...
UpdateCopper	move.l	ScreenOff(a6),d0
		lea	Planes,a1
...
SineLoop	move.l	a0,d3
		add.w	(a2)+,d3
		move.w	#%1111000000000000,bltafwm(a5)
		...
		add.w	(a2)+,d3
		add.l	d0,d3
		move.w	#%0000111100000000,bltafwm(a5)
		move.l	d2,(a3)
		move.l	d3,(a4)
		move.l	d3,(a6)
		move.w	d4,bltsize(a5)
		...
		move.l	a0,d3
		add.w	(a2)+,d3
		move.w	#%0000000011110000,bltafwm(a5)
		move.l	d2,(a3)
		move.l	d3,(a4)
		move.l	d3,(a6)
		move.w	d4,bltsize(a5)
		...
		move.l	a0,d3
		add.w	(a2)+,d3
		move.w	#%0000000000001111,bltafwm(a5)
		move.l	d2,(a3)
		move.l	d3,(a4)
		move.l	d3,(a6)
		move.w	d4,bltsize(a5)
...
TheCopperList	dc.w	diwstrt,$2c81,diwstop,$2cc1
		...
		dc.w	color+$00,$0002,color+$02,$0ffd
...
Text		dc.b	'  THIS IS A FOUR PIXEL SINGLE FRAME SINE SCROLLER '
		dc.b	'WRITTEN BY MIKE CROSS.  FOR A FULL EXPLANATION '
		dc.b	'ON HOW IT WORKS SEE THE TUTORIAL ON ACC 22.  ',-1
