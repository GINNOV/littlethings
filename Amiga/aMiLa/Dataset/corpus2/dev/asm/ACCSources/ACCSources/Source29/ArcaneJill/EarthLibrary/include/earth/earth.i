...
;$VER: earth_earth_i 3.3.1 (27.07.92)
...
;	upon.
; BSRSYS, on the other hand, relies on the existance of a _data-relative
...
BSRERX	MACRO
	XMACRO	EarthRexx,CALL,\1	earthrexx.library
	ENDM
...
BSRGFX	MACRO
	XMACRO	Gfx,CALL,\1		graphics.library
	ENDM
...
BSRLOWMEM MACRO
	XMACRO	LowMem,CALL,\1		lowmem.resource
	ENDM
...
BSRPP	MACRO
	XMACRO	PP,CALL,\1		powerpacker.library
	ENDM
