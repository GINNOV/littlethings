...
; This is an adaption of start.s

; This program will display the amount of CHIP, FAST and total memory
...
.ok		move.l		#MEMF_CHIP,d1	type of mem
		...
		move.l		d0,DataStream
		lea		Template1,a0	format string
		...
		CALLEXEC	AvailMem	how much is free?
		add.l		d0,d7		add free chip to this

		move.l		d0,DataStream
		lea		Template2,a0	format string
		lea		DataStream,a1	data
		lea		PutChar,a2	subroutine
		lea		Text2,a3	buffer
		CALLEXEC	RawDoFmt	create text string

		move.l		d7,DataStream	and store value
		lea		Template3,a0	format string
		lea		DataStream,a1	data
		lea		PutChar,a2	subroutine
		lea		Text3,a3	buffer
		CALLEXEC	RawDoFmt	create text string
...
_UsageText	dc.b		$0a
		dc.b		'No parameters required. Displays free memory!'
		dc.b		$0a
		dc.b		'       © M.Meany, June 1991'
		dc.b		$0a
		dc.b		0
		even
...
WinText		dc.b		1		FrontPen
		...
		dc.w		0		y position
		dc.l		0		font
OurText		dc.l		Text1		address of text to print
		dc.l		WinText1	no more text

Text1		ds.b		100		the text itself
		even
...
WinText1	dc.b		1		FrontPen
		...
		dc.w		10		y position
		dc.l		0		font
		dc.l		Text2		address of text to print
		dc.l		WinText2	no more text

Text2		ds.b		100		the text itself
		even
...
WinText2	dc.b		1		FrontPen
		...
		dc.w		20		y position
		dc.l		0		font
		dc.l		Text3		address of text to print
		dc.l		0		no more text

Text3		ds.b		100		the text itself
		even

Template1	dc.b		'Free CHIP memory  : %ld bytes',0
		even
Template2	dc.b		'Free FAST memory  : %ld bytes',0
		even
Template3	dc.b		'Total free memory : %ld bytes',0
		even
DataStream	dc.l		0
