...
;	Steve Marshall. (Delete most of this when you've read it)

;		M.Meany 	The rest so far !
; Added editing rountines dec 90 MM
; Fixed ARP Load/Save bug 1-2-91 MM -- NOT QUITE !!! MM 8/5/91
...
; Fixed InsertFile routine 8/5/91 MM
; Added delete line routine ( CTRL+Y ) 11/5/91 MM

; Have had contact with S.Marshall, he is of the same opinion as myself. No
;one seems to be interested in the development of this program. I am passing
;a copy to Softville to see what they make of it ! If they distribute it and
;get some response, maybe I'll pick it up again. Until then ACC, R.I.P.

; A pity really, A68K produces code more compact ( optimised ) than Devpac.
...
GotAsmPName	moveq.l		#1,d3
		rts

CancelAsmP	moveq.l		#0,d3
		rts
...
allclosed	rts
		...
		incdir	source:m.meany/acc_source/
