...
Play		move.l		#mtfilename,a0		name of music module
		jsr		FileLen			find out its size
		move.l		d0,mtfilelen
		beq.s		.no_mod
		move.l		#MEMF_CHIP,d1
		CALLEXEC	AllocMem
...
; Now set up interrupt and start music playing
		...
		beq.s		.error			;branch if no error
.no_mod		moveq.l		#0,d0
.error		rts
