; This is the Master Beat 'execware.i' include file,
; for all us hardware bashers. Contains the 'hardware.i' file,
; (author unknown, but THANKS!) and the standard 'exec_lib.i' file.

; The original hardware.i was sent to me by Dave Edwards and is one of many
;such files created by Dave! MM.
