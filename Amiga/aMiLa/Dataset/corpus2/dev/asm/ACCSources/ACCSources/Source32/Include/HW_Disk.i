...
; Write data, d3 already holds size of file
...
; Set a 10 second delay to allow OS to write file
...
; Restore programs interrupts & DMA then Stop drive motors 
...
; Restore system DMA requirements
		...
		or.w		#SETIT!DMAEN!COPEN!BPLEN,d0	set enable bits
...
; Enable DMA
;				 0000 0000 0111 1111
		move.w		#$007f,$dff096		kill all DMA except Cop
		move.w		_tdma,d0
		or.w		#SETIT!DMAEN,d0
