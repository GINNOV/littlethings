...
; Utility to load and play crunched Noisetracker modules. Also allows user
;to save decrunched module.
...
Load		bsr		PointerOn
		tst.l		CIAbase			is a tune playing ?
		bne.s		load_error		if so leave
		tst.l		mt_data			is a mod loaded
