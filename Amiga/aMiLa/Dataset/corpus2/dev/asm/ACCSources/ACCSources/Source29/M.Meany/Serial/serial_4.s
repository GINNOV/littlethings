...
* Name		serial_3.s
* Function	receive a line of text from the serial device, using a
*		command buffer
* Programmer	M.Meany
...
.done		cmp.l		#' dir',Command
		bne		.ReadNext


.exit		move.b		#$0a,buffer
		move.l		std_out,d1
		move.l		#buffer,d2
		moveq.l		#1,d3
		CALLDOS		Write
