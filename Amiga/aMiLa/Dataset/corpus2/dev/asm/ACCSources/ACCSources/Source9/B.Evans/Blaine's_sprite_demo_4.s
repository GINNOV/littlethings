...
;SHIP=SPRITE 0 :MISSILE=SPRITE 1
;JOYSTICK IN PORT 2
;PRESS FIRE TO SEND MISSILE UPWARDS
							;BY BLAINE EVANS
							;1 ERITH WAY
							;PONTYBODKIN
							;NR MOLD
...
mem_required=pf1_sizeof+(spritesize*2)	;memory required=(40*200)*3=24000 bytes
					;+size of sprites in bytes
...
animate_sprite0
	...
	cmpi.b	#20,anim_delay_1	;DELAY OF 20 FRAMES
...
not_fired
	...
	rts
move_missile1
	move.l	sprite1adr,a0		;SPRITE1 ADDRESS
	move.b	vstart1,(a0)+		
	move.b	hstart1,(a0)+
	move.b	vstop1,(a0)+
	move.b	attach1,(a0)+
