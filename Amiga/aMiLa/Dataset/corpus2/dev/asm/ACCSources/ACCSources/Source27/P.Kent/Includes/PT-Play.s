;SOME MODS BY PKENT.
;FROM THE PROTRACKER2.0A DISTRIBUTION DISK (NOT KS2.0!!!)
;(DISK NO 1750 FROM 17BIT : NB v2.1  IS OUT ALREADY)
;
;NB CALL MT_INIT WITH A0=MTDATA!!!!
;NIFTY BUG IN THE ORIGINAL CODE WIPED 1 WORD BEYOND END OF MODULE!
;*REALLY* CRASHED OUT MY MEM-ALLOC ROUTINES!
;TOOK 2 HOURS TO SPOT THIS! KILL!KILL! I HATE USING OTHER PEOPLES CODE
;FOR PRECISELY THIS REASON: YOU HAVENT ANYONE TO BLAME WHEN IT ALL
;BLOWS-UP !
;
;
;********************************************
...
mtloop3
;
;MOD: Modules play OK without wiping the first LW, so I wont, and save
;my ram chunks...
;
;	CLR.L	(A2)
	MOVE.L	A2,(A1)+
