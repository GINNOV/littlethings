...
Openwin		lea		MyWindow,a0	a0->window args
		...
		move.w		wd_MouseX(a0),x
		move.w		wd_MouseY(a0),y
...
***************	Deal with IntuiTick messages

DoTicks		bsr		SeeMouse
...
; Difference is +ve, check for overflow
...
; Difference is -ve, check for underflow
...
WinText		dc.b		1		FrontPen
		...
		dc.w		0		y position
		dc.l		0		font
OurText		dc.l		MMText		address of text to print
		dc.l		0		no more text
