...
TEST_Bobs					; 32 pixels height:full>blank over 9 frames total!
	dc.l	'BOB0'
	dc.b	0,1				; Not init, mask needs building
	dc.w	2+1,32,(9-1)*4
	dc.l	TB_BMAP-TEST_Bobs,TB_MASK-Test_Bobs
	ds.w	5
	dc.l	0
TB_BMAP	incbin	Source:P.Kent/gfx/Spinblocks.irawc
lw.Dispfxcols = *-32*2
TB_MASK	ds.b	9*4*5*32	; 9 Frames, 4 bytes each , 5 planes , 32 height
