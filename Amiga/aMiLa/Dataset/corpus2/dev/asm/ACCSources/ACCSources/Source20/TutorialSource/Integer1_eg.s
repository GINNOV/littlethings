*****	Title		Integer1_eg.s
*****	Function	To demonstrate use of Integer gadgets
*****			
*****			
*****	Size		1304 bytes
*****	Author		Mark Meany
...
;--------------	Initialise the Integer gadgets before opening.

Openwin		lea		Int1Gadg,a0
		move.l		#123,d0
		bsr		BuildIntStr
...
DoIntGadg	lea		Int1Gadg,a0		a0->gadget
		move.l		gg_SpecialInfo(a0),a0	a0->StringInfo
		move.l		si_LongInt(a0),d0	d0=1st value
		
		lea		Int2Gadg,a0
		move.l		gg_SpecialInfo(a0),a0
		move.l		si_LongInt(a0),d1	d1=2nd value

		muls		d1,d0			d0=d0 x d1
		
		move.l		d0,.DStream		save result
		
		lea		.Template,a0		convert result to
		lea		.DStream,a1		ASCII
		lea		.PutChar,a2
		lea		ResultBuffer,a3
		CALLEXEC	RawDoFmt

		move.l		window.rp,a0	a0->windows RastPort
		lea		ResultText,a1	a1->IText structure
