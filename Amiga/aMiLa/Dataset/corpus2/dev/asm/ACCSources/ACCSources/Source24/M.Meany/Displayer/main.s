...
*****	2 May		Using LMB to switch sections
*****			Can specify a CLI type argument to pass to an example
*****			Can specify which example to load
*****			Added DM requester - shortcut menu
