...
;--------------	Display basic usage text for user
		...
		move.l		window.rp,a0	a0->windows RastPort
		lea		MyBorder,a1	a1->Border Sructure
		moveq.l		#10,d0		X offset
		moveq.l		#25,d1		Y offset
		CALLINT		DrawBorder	Draw this border
...
.Text		dc.b		'My House !',0		the text itself
		even
