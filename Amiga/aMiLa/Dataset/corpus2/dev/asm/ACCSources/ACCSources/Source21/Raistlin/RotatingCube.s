...
** Rotating 3D Cube 
**
** Coded by Raistlin on 19.01.92
**
** This program does not incorporate the hidden line removal routine,
** or the fill routine (obviously).  Therefore there is no need to place
** the Z cords in order, because we are blitting to a 2D screen.  Understand that?
**
** Note to Treebeard,
**		     Jesus!  I never thought I'd beat you to 3D vectors!!
** Whos gonna be the first to Filled 3D?  And then, who knows!
**
** NB  Theres something wrong with the no line check (I think).  As sometimes
** nothing is blitted, but the screen is cleared!!!!.
**
** When using Devpac the mouse pointer dont reappear, why?
...
;	move.w	#$fff,$180(a5)		; Raster measure
	...
	moveq.l	#7,d0			; D0=Number of cords to rotate-1
	bsr	Rotate			; Rotate the X,Y,Z

	lea	Vectors,a0		; A0=Address of vectors
	moveq.l	#11,d0			; D0=Number of lines-1
...
.DoY	add.w	#1,2(a2)		; Increment Y angle by 1
	cmpi.w	#360,2(a2)		; Still in 360 range?
	blt	.DoX
	sub.w	#360,2(a2)		; Bring back into 360 range
.DoX	add.w	#1,4(a2)		; Increment X angle by 1
...
E	dc.w	-50,-50,-50,0		; Back face cords
F	dc.w	050,-50,-50,0
G	dc.w	-50,050,-50,0
H	dc.w	050,050,-50,0
...
RotXYZ					; This table stays static
	...
	dc.w	-50,-50,-50,0		; Back face cords
	dc.w	050,-50,-50,0
	dc.w	-50,050,-50,0
	dc.w	050,050,-50,0
