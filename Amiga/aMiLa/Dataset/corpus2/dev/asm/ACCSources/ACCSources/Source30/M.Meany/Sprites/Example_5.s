...
; Sprite Example 5:	Reusing A Sprite DMA Channel
...
;macro will assume SprtBase!
		...
		SPRITEON	#0,#Sprite1		Turn sprite on
...
Level3		lea		$dff000,a5		a5->hardware base
...
.done		move.w		INTREQR(a5),d0		get bits
...
Boing		lea		Sprite1,a0		a0->sprite
		lea		Sprite2,a1
...
.BoingX		neg.w		spr_dX(a0)
		neg.w		spr_dX(a1)

.DoY		move.w		spr_Y(a0),d0
		add.w		spr_dY(a0),d0
...
Sprite2		dc.w		201		X
		dc.w		128		Y
		dc.w		20		height
		dc.l		sprite2Data	address of data
		dc.w		4		dX
		dc.w		2		dY
...
;		dc.l		sprite2Data	next sprite pointer

sprite2Data	dc.w		0 		1st control word
		dc.w		0 		2nd control word
