...
picloop
	...
	move.l a1,a3		a3-->picture start address
	move.l a0,a4		a4-->bit plane start address
	add.l #10240,a1		a1-->end of picture BP
	add.l #20240,a4		a1-->end of SECOND bit plane
	add.l #10240,a3		a3-->start of SECOND picture plane
	move.l d0,d1		save d0
	mulu #40,d0		mutiply line num by bytes per line
	sub.l d0,a1		a1-->start of data to be copied(in picture bpl)
	sub.l d0,a4		a4-->start of SECOND bit plane where data is copied to 
...
copyloop1
	move.l (a3)+,(a4)+	COPY FROM PIC PLANE 1 TO BIT PLANE 1
