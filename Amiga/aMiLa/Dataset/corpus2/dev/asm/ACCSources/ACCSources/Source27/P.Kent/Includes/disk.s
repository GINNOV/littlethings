...
*       BUGFIX 24/6/92: PRESLIST NOW WORKS!        *
****************************************************
	RSRESET
LFE_ALLOK	RS.B	1				; :-)
...
LOADFILE
	PUSH D2-D7/A0-A6
	MOVE.W	#LFE_NOFILE,W.FERROR(A5)	; DEAFAULT ERROR
	MOVE.L A0,L.FILENAME(A5)
	MOVE.L A1,L.DESTADDR(A5)
	MOVE.W D1,W.LOADFUNC(A5)
;LOCK FILE & GET LENGTH...
	MOVE.L 4.W,A6
	LEA DOSNAME(PC),A1
	JSR -$198(A6)					; OPENLIB
	TST.L	D0
	...
	move.l  d0,L.FILELEN(A5)		; file size
...
LF_NOTLH
	...
	MOVE.L	L.FILELEN(A5),D3
	MOVE.L	L.DESTADDR(A5),D2
	MOVE.L	d7,D1
	JSR	-$2A(A6)					; READ(LOCK,BUFF,LENGTH)
	CMP.L	L.FILELEN(A5),D0
	BNE.S	XLF3

XLFOK	MOVE.W	#LFE_ALLOK,W.FERROR(A5)
XLF3
	MOVE.L	d7,D1					; CLOSE(LOCK)
	JSR	-$24(A6)
XLF2
	MOVE.L	A6,A1
	MOVE.L 4.W,A6
...
LF_ISLH
	...
	MOVE.L	(A0)+,D1				; Put length in d1
	AND.L	#$00FFFFFF,D1			; MASK  -1 byte at start
	BSR LF_DOLOADFUNC				; AllocIt as reqd...
