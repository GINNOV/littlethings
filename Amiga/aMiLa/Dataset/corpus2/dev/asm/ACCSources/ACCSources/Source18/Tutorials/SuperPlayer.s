...
; Yet another adaption of the Int_Startup.s routine ...... 

; A Noistracker player that opens a window. Close window to stop tune!
...
;		opt 		o+,ow-
		...
		XDEF		_GfxBase,_PPBase	Exports

		XREF		PlayFile,StopPlaying	Imports
...
; Include easystart to allow a Workbench startup.
		...
		move.b		#0,-1(a0,d0)	NULL CLI parameters
...
no_win		jsr		StopPlaying	stop music
...
_UsageText	dc.b		$0a
		dc.b		'PowerPacked NoiseTracker Module Replayer.'
		dc.b		$0a
		dc.b		'Usage: Player <filename>',$0a
		dc.b		'Where <filename> is pathname of module.',$0a
		dc.b		$0a
		dc.b		'Written as part of an ACC Tutorial! M.Meany, Nov 91.'
		dc.b		$0a
		dc.b		0
		even
