...
loop	move.l	vposr(a5),d0	d0=beam position
	...
	addq.b	#1,4(a0)	1st strip down
	addq.b	#1,12(a0)	2nd strip down
	addq.b	#1,20(a0)	3rd strip down
	addq.b	#1,28(a0)	4th strip down
	addq.b	#1,36(a0)	5th strip down
	addq.b	#1,44(a0)	background down
	bra.s	chk_direction	jump over up rountin
	
up	subq.b	#1,4(a0)	1st strip up
	subq.b	#1,12(a0)	2nd strip up
	subq.b	#1,20(a0)	3rd strip up
	subq.b	#1,28(a0)	4th strip up
	subq.b	#1,36(a0)	5th strip up
	subq.b	#1,44(a0)	background up
