/*
 ...
 This example shows volumes (a pyramid and a cube) rotating on themselves.
...
int main ( int argc, char** argv )   // Create Main Function For Bringing It All Together
{
  ...
  glutInitWindowSize  ( 640, 400 ); // If glutFullScreen wasn't called this is the window size
