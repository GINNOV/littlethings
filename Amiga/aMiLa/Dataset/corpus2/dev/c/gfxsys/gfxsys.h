...
#define GWF_SYSTEMMASK		0x0000000F //first 4 bits are system flags

#define GWF_RETAINASPECT	(1<<4)
#define GWF_USERMASK			0xFFFFFFF0 
...
extern struct GfxView * CreateGfxView (struct TagItem *TagList);
extern struct GfxView * CreateGfxViewTags (ulong FirstTag, ... );
extern void CloseGfxView (struct GfxView *GfxView);

extern struct GfxWindow * AddGfxWindow 	(struct GfxView * GV,struct TagItem *TagList);
extern struct GfxWindow * AddGfxWindowTags (struct GfxView * GfxView,ulong FirstTag, ... );
extern void ModifyGfxWindow	(struct GfxWindow * GfxWindow,struct TagItem *TagList);
extern void ModifyGfxWindowTags(struct GfxWindow * GfxWindow,ulong FirstTag, ...);
extern void RemoveGfxWindow (struct GfxView * GV,struct GfxWindow *GW);

extern struct GfxObject * AddGfxObject	(struct GfxWindow *GfxWindow,struct TagItem *TagList);
extern struct GfxObject * AddGfxObjectTags (struct GfxWindow *GfxWindow,ulong FirstTag, ... );
extern void ModifyGfxObject	(struct GfxObject *GfxObject,struct TagItem *TagList);
extern void ModifyGfxObjectTags(struct GfxObject * GfxObject,ulong FirstTag, ...);
extern void RemoveGfxObject	(struct GfxWindow *GfxWindow,struct GfxObject *GfxObject);
