...
#define MSG_FATAL_CO75_2_STR "! Usage: ctangle [options] webfile[.w] [{changefile[.ch]|-} [outfile[.c]]]\nOptions are (+ turns on, - turns off, default in brackets):\nb [+] print banner line\nh [+] print happy message\np [+] give progress reports\ns [-] show statistics\n"
...
#define MSG_FATAL_CO75_4_STR "! Usage: cweave [options] webfile[.w] [{changefile[.ch]|-} [outfile[.tex]]]\nOptions are (+ turns on, - turns off, default in brackets):\nb [+] print banner line\nf [+] force line breaks\nh [+] print happy message\ni [+] indent parameter declarations\nlX [ ] use macros for language X as of Xcwebmac.tex\no [+] separate declarations and statements\np [+] give progress reports\ns [-] show statistics\nx [+] include indexes and table of contents\n"
...
#define MSG_BANNER_CT1_STR "This is CTANGLE (Version 3.3 [p11])\n"
...
#define MSG_BANNER_CW1_STR "This is CWEAVE (Version 3.3 [p11])\n"
