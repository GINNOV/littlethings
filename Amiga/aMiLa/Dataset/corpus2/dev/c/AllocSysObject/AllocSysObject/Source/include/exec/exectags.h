...
/* OS4EMU
 *
 * Copyright (C) 2004-2007 Ilkka Lehtoranta
 *
 * $Id: exectags.h,v 1.3 2007/12/20 22:05:31 cvsu-ilkleht Exp $
 */
...
#define ASODMAE_Size		(TAG_USER + 10)
#define ASODMAE_NumEntries	(TAG_USER + 11)
...
#define ASOT_HOOK      1
#define ASOT_INTERRUPT 2
#define ASOT_LIST      3
#define ASOT_DMAENTRY  4
#define ASOT_NODE      5
#define ASOT_PORT      6
