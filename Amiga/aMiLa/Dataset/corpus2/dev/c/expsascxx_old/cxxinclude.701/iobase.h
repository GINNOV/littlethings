...
/* NOTES:                                                            */
/*     For converting a streampos to/from an int; we need to handle  */
/*      fpos's as well.  However, fpos isn't portably convertable    */
/*      with 'int' (technically, neither is a streampos.) So we      */
/*      only support conversion with streampos and int on hosts      */
/*      where fpos_t is convertable. with int.                       */
/* ALGORITHM:                                                        */
/* END                                                               */
/*-------------------------------------------------------------------*/
