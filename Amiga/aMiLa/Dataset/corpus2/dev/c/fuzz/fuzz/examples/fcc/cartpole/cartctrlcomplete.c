...
void FL_SetcartctrlcompletePos(double value)
...
void FL_SetcartctrlcompletePosdot(double value)
...
void FL_SetcartctrlcompleteAngle(double value)
...
void FL_SetcartctrlcompleteAngledot(double value)
...
void FL_SetcartctrlcompleteControl(double value)
...
double FL_GetcartctrlcompletePos(void)
...
double FL_GetcartctrlcompletePosdot(void)
...
double FL_GetcartctrlcompleteAngle(void)
...
double FL_GetcartctrlcompleteAngledot(void)
...
double FL_GetcartctrlcompleteControl(void)
...
void FL_Runcartctrlcomplete(void)
...

{
  ...
  if (argc != FL_NUMVARIABLES+1)
     {
      printf("Error: Need 5 inputs\n");
      return(1);
     }

  for (i = 1; i < argc; i++)
      flvariable_val[i-1] = atof(argv[i]);
  FL_Runcartctrlcomplete();
  for (i = 0; i < FL_NUMVARIABLES; i++)
