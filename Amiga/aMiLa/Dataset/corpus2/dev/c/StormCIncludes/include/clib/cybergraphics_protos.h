...
ULONG        MovePixelArray(UWORD, UWORD, struct RastPort *, UWORD, UWORD, UWORD, UWORD);
...
LONG         ScalePixelArray(APTR,UWORD,UWORD,UWORD,struct RastPort *,UWORD, UWORD,UWORD,UWORD,UBYTE);
