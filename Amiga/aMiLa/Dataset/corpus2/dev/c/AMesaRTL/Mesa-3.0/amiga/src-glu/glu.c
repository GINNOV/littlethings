/* $Id: glu.c,v 1.10 1998/04/22 00:35:50 brianp Exp $ */
 ...
 * jarno@kcbbs.gen.nz
 *
 * File created from glu.c ver 1.9 and glu.h ver 1.9 using GenProtos
 *
 * Version 2.0  13 Sep 1998
 * by Jarno van der Linden
 * jarno@kcbbs.gen.nz
 *
 * - Added an __stdargs to glutLookAt
 *
 * Version 2.1  04 Oct 1998
 * by Jarno van der Linden
 * jarno@kcbbs.gen.nz
 *
...
__asm __saveds void APIENTRY gluLookAtA(register __a0 void *vargs)
{
	...
	args = (struct gluLookAtArgs *)vargs;

	gluLookAt(args->eyex, args->eyey, args->eyez, args->centerx, args->centery, args->centerz, args->upx, args->upy, args->upz);
}


__stdargs __saveds void APIENTRY gluLookAt( GLdouble eyex, GLdouble eyey, GLdouble eyez,
...
__asm __saveds void APIENTRY gluOrtho2D( register __fp0 GLdouble left, register __fp1 GLdouble right,
...
__asm __saveds void APIENTRY gluPerspective( register __fp0 GLdouble fovy, register __fp1 GLdouble aspect,
...
__asm __saveds void APIENTRY gluPickMatrix( register __fp0 GLdouble x, register __fp1 GLdouble y,
...
__asm __saveds const GLubyte* APIENTRY gluErrorString( register __d0 GLenum errorCode )
{
...
__asm __saveds const GLubyte* APIENTRY gluGetString( register __d0 GLenum name )
{
