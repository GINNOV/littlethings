/* $Id: nurbs.c,v 1.13 1998/06/01 01:07:49 brianp Exp $ */
 ...
 * jarno@kcbbs.gen.nz
 *
 * - Changed to version 1.13 of nurbs.c
 *
 */
...
__asm __saveds void APIENTRY gluNurbsCurve( register __a0 GLUnurbsObj *nobj, register __d0 GLint nknots, register __a1 GLfloat *knot,
                                            register __d1 GLint stride, register __a2 GLfloat *ctlarray, register __d2 GLint order, register __d3 GLenum type )
{
...
__asm __saveds void APIENTRY gluBeginSurface( register __a0 GLUnurbsObj *nobj )
{
...
__asm __saveds void APIENTRY gluEndSurface( register __a0 GLUnurbsObj * nobj )
{
    switch(nobj->nurbs_type)
    {
        case GLU_NURBS_NONE:
...
__asm __saveds void APIENTRY gluNurbsSurface( register __a0 GLUnurbsObj *nobj,
                                              ...
                                              register __a3 GLfloat *ctrlarray,
...
__asm __saveds void APIENTRY gluNurbsCallback( register __a0 GLUnurbsObj *nobj, register __d0 GLenum which,
...
__asm __saveds void APIENTRY gluBeginTrim( register __a0 GLUnurbsObj *nobj )
{
#if 0
    nurbs_trim *ptr;
#endif
...
__asm __saveds void APIENTRY gluPwlCurve( register __a0 GLUnurbsObj *nobj, register __d0 GLint count,
...
__asm __saveds void APIENTRY gluEndTrim( register __a0 GLUnurbsObj *nobj )
{
    if(nobj->nurbs_type!=GLU_NURBS_TRIM)
    {
