/* $Id: vbrender.c,v 3.6 1998/08/06 01:36:38 brianp Exp $ */
 ...
 * jarno@kcbbs.gen.nz
 *
 * - Changed to v3.6 of vbrender.c
 * - Global optimizer outsmarted me: tried another work around
 *
 */
                              ...
                              GLuint pv, GLuint facing )
{
   ...
   if (mode==GL_POINT) {
      ...
      for (i=2;i<n;i++) {
         ...
         debug_triangle();
#endif
         (*ctx->Driver.TriangleFunc)( ctx, j0, *j, *(j+1), pv );
