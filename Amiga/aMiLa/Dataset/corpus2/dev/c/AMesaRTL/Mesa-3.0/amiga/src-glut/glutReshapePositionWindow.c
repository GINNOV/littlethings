...
__asm __saveds void glutReshapeWindow( register __d0 int width, register __d1 int height )
{
...
__asm __saveds void glutPositionWindow( register __d0 int x, register __d1 int y )
{
