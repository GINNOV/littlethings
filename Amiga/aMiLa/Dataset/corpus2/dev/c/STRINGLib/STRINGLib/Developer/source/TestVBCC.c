...
/* 11.12.1998 Michaela Prüß, i make a vbcc-version of the test
 * will you know what happend? compile and lock...!
 */

#include <stdio.h>
#include <string.h>
#include "TestVBCC_protos.h"
...
//	check(index(one, '\0') == one, 8);	/* NUL in empty string. */
    ...
    printf("test 'index' skipped, because not exists in vbcc\n");
...
//	check(rindex(one, '\0') == one, 8);	/* NUL in empty string. */
    ...
    printf("test 'rindex' skipped, because not exists in vbcc\n");
}
...
//	equal(two, "xbcdlebee", 15);
    ...
    printf("test 'memccpy' skipped, because not exists in vbcc\n");
    ...
    printf("ending testprogramm without checking Berklix-functions\n");
	printf("they not be exists in vbcc\n");
	return;
