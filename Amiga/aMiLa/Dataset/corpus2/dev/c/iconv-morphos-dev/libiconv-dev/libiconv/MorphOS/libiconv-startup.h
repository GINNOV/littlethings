...
#define call_libiconvctl(__p0, __p1, __p2) \
	({ \
...
#define call_libiconvlist(__p0, __p1) \
	({ \
...
#define call_libiconv_close(__p0) \
	({ \
		iconv_t  __t__p0 = __p0;\
		long __base = (long)(ICONV_BASE_NAME);\
		__asm volatile("mr 12,%0": :"r"(__base):"r12");\
...
#define call_libiconv_set_relocation_prefix(__p0, __p1) \
	({ \
...
#define call_libiconv(__p0, __p1, __p2, __p3, __p4) \
	({ \
		iconv_t  __t__p0 = __p0;\
		const char ** __t__p1 = __p1;\
		size_t * __t__p2 = __p2;\
...
#define call_iconv_canonicalize(__p0) \
	({ \
		const char * __t__p0 = __p0;\
		long __base = (long)(ICONV_BASE_NAME);\
		__asm volatile("mr 12,%0": :"r"(__base):"r12");\
...
#define call_libiconv_open(__p0, __p1) \
	({ \
		const char * __t__p0 = __p0;\
		const char * __t__p1 = __p1;\
		long __base = (long)(ICONV_BASE_NAME);\
