...
/* The hack with XPFILEn had to be removed for Amiga, because PFILE needs to be
   an absolute pathname within QUOTES and SAS/C's DEF option cannot recognize
   \" as a quote !
*/

#define PFILE1  "S:bison++.simple.cc"
#define PFILE2  "S:bison++.hairy.cc"
