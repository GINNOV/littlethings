...
#ifndef COMPILE_V39
const STRPTR NRDArgsID = "NewReadArgs 37.4 © 1997-1999 by Stephan Rupprecht";
#else 
const STRPTR NRDArgsID = "NewReadArgs 39.4 © 1997-1999 by Stephan Rupprecht";
#endif
...
{	
	const static struct TagItem icontags[] = {
		...
		if(WBStartup) 
		{
					...
					num++, wbarg++	)
			{
				...
				dobj = ( IconBase->lib_Version < 44L ) ? 
						...
						GetIconTagList(wbarg->wa_Name, icontags);
