...
#undef LIBFUNC
  ...
  #define LIBFUNC
    ...
    #define LIBSTUBVA(name, ret, ...)                                 \
      ...
      libstub_##name(struct Interface *self UNUSED, __VA_ARGS__)
  #endif
  #define LFUNC_FAS(name)  (APTR)libstub_##name
  #define LFUNC_VAS(name)  (APTR)libstub_##name
  #define LFUNC_FA_(name) ,(APTR)libstub_##name
  #define LFUNC_VA_(name) ,(APTR)libstub_##name
  #define LFUNC(name)      (APTR)libstub_##name
  ...
  #endif
  #define LFUNC_FAS(name)  (APTR)name
  #define LFUNC_VAS(name)  (APTR)name
  #define LFUNC_FA_(name) ,(APTR)name
  #define LFUNC_VA_(name) ,(APTR)name
  #define LFUNC(name)      (APTR)name
#endif
