 ...
 *
 * Modified 2/2001 R. L. Zarling for use with the Amiga compiler StormC v4.
 * If you find an improved configuration for this machine, please
 * contact me at rayz@cs.csustan.edu.
 *
