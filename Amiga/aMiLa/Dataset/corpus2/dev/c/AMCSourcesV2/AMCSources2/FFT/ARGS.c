...
static int help();
//static int gripe_arg(char *s);
static int numeric(char *s);
/*---------------------------------------------------------------*/
/*	write out the command line */
fprint_cmd(FILE *fp,char *format)
...
*/
int get_double(int argc,char **argv,int permitted,double *a)	/* returns # arguments used */
 									/* # argument strings left */
 								/* ptr to string array */
 								/* # pointers following */
									/* the first of the pointers */
{	int i=1;
	double **dp = &a;
