...
/*
 *      forstmt parses the c for construct.
 *	DAW: little changes had to be added to get compiled with the SAS/C 6.50
 *	     (the replaced original lines were put between comment markers).
 *
 */
