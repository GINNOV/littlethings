...
/* all of above fields must match first fields in enode! */
	...
	union {								/* V2 */
		long	goffs;		/* offsets for OREG, ONAME */	/* V2 */
		double	gfval;		/* value of FCON */		/* V2 */
	} gu;								/* V2 */
	long	bsize;		/* AGREG size or misc. */		/* V2 */
	struct {							/* V2 */
#ifndef NOFIELDS							/* V2 */
#ifdef AZ_HOST								/* V2 */
		unsigned gfldw:6, gfldo:6;	/* BUG! */		/* V2 */
#if (sizeof(unsigned)==2)		/* Added by TETISOFT */
		short	fill;		/* Added by TETISOFT */
#endif					/* Added by TETISOFT */
#else									/* V2 */
		int	gfldw:6, gfldo:6;	/* field info */	/* V2 */
#if (sizeof(int)==2)			/* Added by TETISOFT */
		short	fill;		/* Added by TETISOFT */
#endif					/* Added by TETISOFT */
#endif									/* V2 */
#else									/* V2 */
		char	gfldw, gfldo;	/* use if no fields */		/* V2 */
		short	fill;		/* Added by TETISOFT */
#endif									/* V2 */
/*		short	fill; */	/* Commented out by TETISOFT */	/* V2 */
	} gfl;								/* V2 */
};
