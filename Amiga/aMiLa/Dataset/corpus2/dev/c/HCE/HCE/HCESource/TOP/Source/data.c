...
/* CHANGED BY TETISOFT */
/* For use with cclib.library, which destroys D0-D3, A0-A2 and A6,
 * we have to beware of that.
 *
 * 15-01-91 TetiSoft CClib.library V3.0 seems to keep D3 and A2
 * Status of D2: see inst.h
 * 20-05-91 TetiSoft A2 as register variable
 */
#ifndef	CCLIB
			return	RM(A0)|RM(A1)|RM(A2)|
				RM(D0)|RM(D1)|RM(D2)|RM(SP);
#else
			return	RM(A0)|RM(A1)|RM(A6)|
				RM(D0)|RM(D1)|RM(D2)|RM(SP);
#endif
