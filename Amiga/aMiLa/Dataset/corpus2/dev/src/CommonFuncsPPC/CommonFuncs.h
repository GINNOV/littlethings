...
# ifndef  StrBfPtr
#  define StrBfPtr( g ) ((STRPTR) ((struct StringInfo *)g->SpecialInfo)->Buffer)
...
PUBLIC BOOL FileExists( char *fileName ); // For V3.6

# ifndef __amigaos4__
// Duplicate StringFunctions.c for SAS-C : -----------------------------------------------
IMPORT void StringNCopy( char *dest, char *src, int size );

IMPORT int stoi( char **inputString );
IMPORT int StringCopy( char *dest, char *src );
IMPORT int StringLength( char *str );
IMPORT int StringComp( char *str1, char *str2 );
IMPORT int StringNComp( char *str1, char *str2, unsigned int size );
IMPORT int StringNIComp( char *str1, char *str2, int length );
IMPORT int StringIComp( char *str1, char *str2 );
...
IMPORT char *SubString( char *str, char *end );
IMPORT char *StringCat( char *string1, char *string2 );
IMPORT char *StringNCat( char *string1, char *string2, int maxSize );
IMPORT char *UpperCase( char *inputString );
IMPORT char *LowerCase( char *inputString );
IMPORT char *ReverseString( char *string );
IMPORT char *ReplaceChar( char *string, char old_char, char new_char );

# endif // __amigaos4__

// ---------------------------------------------------------------------------------------

IMPORT char *GetUserString( struct Window *parentW, char *requestMsg, char *wTitle );

IMPORT char *TrimSpaces( char *string );
...
IMPORT char *Byt2Str( char *out, char input );
