...
void delete_AttributeList(AttributeListPtr);
int AttributeList__Size(AttributeListPtr);
AttributeListPtr AttributeList__Copy(AttributeListPtr);
void AttributeList__AddAttribute(AttributeListPtr, AttributePtr);
