...
void delete_TestList(TestListPtr);
int TestList__Size(TestListPtr);
void TestList__AddTest(TestListPtr, TestPtr);
void TestList__AddTestList(TestListPtr, TestListPtr);
void TestList__Copy(TestListPtr, TestListPtr);
