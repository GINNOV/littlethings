...
typedef struct _TriangleStrip {
#define INC_REASON INFO_ITEM_STRUCT
#include "TriStrp.h"
#undef INC_REASON
} TriangleStrip, *TriangleStripPtr;

TriangleStripPtr new_TriangleStrip();
void delete_TriangleStrip(TestPtr);
TestPtr TriangleStrip__Copy(TestPtr);
void TriangleStrip__Layout(VertexPtr);
