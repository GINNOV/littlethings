...
typedef struct _LineStrip {
#define INC_REASON INFO_ITEM_STRUCT
#include "LineStrp.h"
#undef INC_REASON
} LineStrip, *LineStripPtr;

LineStripPtr new_LineStrip();
void delete_LineStrip(TestPtr);
void LineStrip__Print(TestPtr, int, TestPtr);
TestPtr LineStrip__Copy(TestPtr);
void LineStrip__Layout(VertexPtr);
