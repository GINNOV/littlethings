...
#undef INC_REASON
#ifdef WIN32
} PolygonStr, *PolygonPtr; /* Name conflict with Win32 */
#else
} Polygon, *PolygonPtr;
#endif

PolygonPtr new_Polygon();
void delete_Polygon(TestPtr);
int Polygon__SetState(TestPtr);
TestPtr Polygon__Copy(TestPtr);
void Polygon__Layout(VertexPtr);
