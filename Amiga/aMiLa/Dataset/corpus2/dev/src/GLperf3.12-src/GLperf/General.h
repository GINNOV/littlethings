...
void SetDefaults(TestPtr, InfoItemPtr);
int Apply(TestPtr, int, AttributePtr);
AttributeListPtr GetAllAttrs(TestPtr, int);
void CopyStrings(TestPtr, TestPtr);
void FreeStrings(TestPtr);
void* AlignMalloc(int, int);
void AlignFree(void*);
void DefineTexImage(int, int, int, int, int, int, int, int, int, int, void*);
