...
#define INFO_ITEM_ARRAY  10
#define INFO_ITEM_STRUCT 11

typedef struct _TypeDependentData {
    GLfloat value;
    char* verbose;
} TypeDependentData, *TypeDependentDataPtr;

typedef struct _DefaultData {
    int   intValue;
    GLfloat floatValue;
    char *stringValue;
} DefaultData, *DefaultDataPtr;
...
typedef struct _InfoItem {
    ...
    int offset;
    int type;
    TypeDependentData typeDependentData[75];
    DefaultData defaultData;
} InfoItem, *InfoItemPtr;
