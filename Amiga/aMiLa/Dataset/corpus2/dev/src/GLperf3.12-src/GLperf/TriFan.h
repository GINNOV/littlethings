...
typedef struct _TriangleFan {
#define INC_REASON INFO_ITEM_STRUCT
#include "TriFan.h"
#undef INC_REASON
} TriangleFan, *TriangleFanPtr;

TriangleFanPtr new_TriangleFan();
void delete_TriangleFan(TestPtr);
TestPtr TriangleFan__Copy(TestPtr);
void TriangleFan__Layout(VertexPtr);
