...
#define RangedInteger    1
#define UnrangedInteger  2
#define RangedFloat 3
#define UnrangedFloat   4
#define RangedFloatOrInt 5
#define UnrangedFloatOrInt   6
#define Enumerated   7
#define StringType   8
#define RangedHexInteger 9
#define UnrangedHexInteger 10
#define PrintfStringType   11
#define NoPrint 16
#define NotSettable 32
...
void PrintResults(TestPtr, TestPtr, float, int);
