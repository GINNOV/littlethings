...
TablePtr new_Table();
void delete_Table(TablePtr);
int Table__Load(TablePtr, StringValuePtr, int);
int Table__Lookup(TablePtr, const char*, int*);
int Table__InverseLookup(TablePtr, char*, int);
