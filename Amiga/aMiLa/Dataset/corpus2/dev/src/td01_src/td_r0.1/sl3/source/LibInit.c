...
ULONG __saveds __stdargs L_OpenLibs(struct x3Base *x3Base);
...
char __aligned tdo3XLibName [] = "dummy4.library";
char __aligned tdo3XLibID   [] = "$VER:dummy4 1.0 (15.5.99)";
#endif
...
#else
{
 ...
 0x80, (UBYTE) OFFSET(Node,    ln_Name),      (ULONG) &tdo3XLibName[0],
 INITBYTE(OFFSET(Library,      lib_Flags),    LIBF_SUMUSED|LIBF_CHANGED),
 INITWORD(OFFSET(Library,      lib_Version),  VERSION),
 INITWORD(OFFSET(Library,      lib_Revision), REVISION),
 0x80, (UBYTE) OFFSET(Library, lib_IdString), (ULONG) &tdo3XLibID[0],
 (ULONG) 0
};
#endif
