...
do_sigbits
	...
	move.l	#RXCOMM!RXFF_STRING,rm_Action(a0)
	lea	rm_Args(a0),a1
	lea	command_stg(pc),a2
	move.l	a2,(a1)
	lea	rexxname(pc),a2
	move.l	a2,rm_FileExt(a0)
	clr.l	rm_Result1(a0)
	clr.l	rm_Result2(a0)
	move.l	input,rm_Stdin(a0)
	move.l	output,rm_Stdout(a0)
 ...
 * You could use the above signals and Wait() instead of waitport().

waiting	move.l	156(a4),a0
	move.l	4.w,a6
	jsr	_LVOWaitPort(a6)
	move.l	156(a4),a0
	jsr	_LVOGetMsg(a6)
...
command_stg	dc.b	'say',34,'Hello Arexx! - How Are You?!',34,10,0


 * Buffer Variables.

membuf		dcb.b	300,0
rx_msg		dcb.b	RMSIZEOF


	SECTION	VERSION,DATA

	dc.b	'$VER: Arexx_Msg.s V1.01 (22.4.2001)',0
