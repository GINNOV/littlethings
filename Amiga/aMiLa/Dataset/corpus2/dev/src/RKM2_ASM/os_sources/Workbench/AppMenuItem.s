 ...
 * This program requires you to execute this program, then LShift-Select
 * upto two FILEs (not DRAWERs) and whilst still LShift-Selected use
 * WBTools->Hello There. When you release the WBTools->Hello There menu item
 * you will see the filenames of the LShift-Selected files in the window.
 *
...
wndw_title	dc.b	'AppMenuItem.s',0
font_name	dc.b	'topaz.font',0,0
menu_stg	dc.b	'Hello There',0
...
membuf		dcb.b	300,0
	...
	dc.b	'$VER: AppMenuItem.s V1.01 (22.4.2001)',0
