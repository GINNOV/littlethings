 ...
 * This program shows you how to set up a Simple Sprite.
...
zero_args
	...
	lea	ssobj(pc),a0
	moveq	#-1,d0			; can be a number between 0-7
	move.l	152(a4),a6
...
loop1	suba.l	a0,a0
	...
	jsr	_LVOWaitTOF(a6)		; This is smoother than Delay()
	jsr	_LVOWaitTOF(a6)
...
image1	dc.w	$0000,$0000
	...
	dc.b	'$VER: Simple_Sprite.s V1.01 (22.4.2001)',0
