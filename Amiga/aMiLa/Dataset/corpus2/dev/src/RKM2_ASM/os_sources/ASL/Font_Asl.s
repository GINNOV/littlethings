...
asltags
	dc.l	ASLFO_InitialLeftEdge,0
	dc.l	ASLFO_InitialTopEdge,0
	dc.l	ASLFO_InitialWidth,305
	dc.l	ASLFO_InitialHeight,255
	dc.l	ASLFO_InitialName,font_name
	dc.l	ASLFO_InitialSize,8
	dc.l	ASLFO_InitialStyle,FSF_BOLD!FSF_ITALIC
	dc.l	ASLFO_InitialFlags,FS_NORMAL
	dc.l	ASLFO_InitialFrontPen,2
	dc.l	ASLFO_InitialBackPen,1
	dc.l	ASLFO_InitialDrawMode,1
	dc.l	ASLFO_TextAttr,topaz9
	dc.l	ASLFO_TitleText,asltitle
	dc.l	ASLFO_PositiveText,okstg
	dc.l	ASLFO_NegativeText,cancelstg
	dc.l	ASLFO_DoStyle,TRUE
	dc.l	ASLFO_DoFrontPen,TRUE
	dc.l	ASLFO_DoBackPen,TRUE
	dc.l	ASLFO_DoDrawMode,TRUE
	dc.l	ASLFO_MinHeight,8	; Min to Max Font Sizes allowed
	dc.l	ASLFO_MaxHeight,19
	dc.l	ASLFO_MaxBackPen,4	; Use a pointer to screen depth
	dc.l	ASLFO_MaxFrontPen,4
*	dc.l	ASLFO_FixedWidthOnly,TRUE
	dc.l	ASLFO_ModeList,labels

* ASLFO_Flags here is only for show - Use the above tags instead.
*	dc.l	ASLFO_Flags,FOF_DOFRONTPEN!FOF_DOBACKPEN!FOF_DOFONTSTYLE!FOF_DODRAWMODE!FOF_FIXEDWIDTHONLY

*	dc.l	ASLFO_Screen,scrnwndw
*	dc.l	ASLFO_Window,wndwptr
	dc.l	TAG_DONE

cl0	dc.b	'DrawMode ',0
cl1	dc.b	'JAM1',0,0
cl2	dc.b	'JAM2',0,0
cl3	dc.b	'Complement',0,0

labels	dc.l	cl0,cl1,cl2,cl3,0
...
membuf		dcb.b	300,0
	...
	dc.b	'$VER: Font_ASL.s V1.01 (22.4.2001)',0
