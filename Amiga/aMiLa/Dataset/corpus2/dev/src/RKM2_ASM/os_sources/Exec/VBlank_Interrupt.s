 ...
 * This code shows how set-up a Vertical Blank Interrupt, which is basically
 * an interrupt that uses a variable to count off the number of VBlanks.
 * A good use for a VBlank Interrupt is when you want to use it as some sort
 * of timer/time-out independant of your program code.
...
cname		dc.b	'CON:0/0/640/80/ VBlank_Interrupt.s',0
is_name		dc.b	'JW_Interrupt',0,0
stg0
	dc.b	' ',10,'VBlank Active - Wait about 10 to 30 seconds and then press CTRL-C to quit.',10
	even
stg0_len		equ	*-stg0

stg1
	dc.b	' ',10,'VBlank Disabled - Number of VBlanks passed: '
	even
stg1_len		equ	*-stg1
...
char10		dcb.b	1,10
	...
	dc.b	'$VER: VBlank_Interrupt.s V1.01 (22.4.2001)',0
