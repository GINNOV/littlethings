...
beep	move.l	#$DFF0A0,a0		; Channel Zero
	move.l	#notes0,(a0)		; Waveform Data
	move.w	#8,4(a0)		; Length of waveform in words
	move.w	#400,6(a0)		; Sample Period
	move.w	#64,8(a0)		; Volume
	move.l	#$DFF096,a0
	move.w	#$8201,(a0)		; DMA Control ($8000+$200+$1)

	move.l	#$DFF0B0,a0		; Channel One
	move.l	#notes1,(a0)		; Waveform Data
	move.w	#8,4(a0)		; Length of waveform in words
	move.w	#400,6(a0)		; Sample Period
	move.w	#64,8(a0)		; Volume
	move.l	#$DFF096,a0
	...
	move.l	#$DFF0C0,a0		; Channel Two
	move.l	#notes2,(a0)		; Waveform Data
	move.w	#8,4(a0)		; Length of waveform in words
	move.w	#400,6(a0)		; Sample Period
	move.w	#64,8(a0)		; Volume
	move.l	#$DFF096,a0
	...
	move.l	#$DFF0D0,a0		; Channel Three
	move.l	#notes3,(a0)		; Waveform Data
	move.w	#8,4(a0)		; Length of waveform in words
	move.w	#400,6(a0)		; Sample Period
	move.w	#64,8(a0)		; Volume
	move.l	#$DFF096,a0
	...
	move.l	#20000,d0		; Beep loop counter
loop	dbf	d0,loop
	rts
...
wndw_title	dc.b	'Close this window for a quiet life!',0
...
notes0		dc.w	40,60,80,100,120,140,160,180,-24,0
notes1		dc.w	140,170,190,200,190,170,140,10,-14,0
notes2		dc.w	240,270,290,200,290,270,240,20,-24,0
notes3		dc.w	240,270,290,200,290,270,240,20,-24,0


	SECTION	VERSION,DATA

	dc.b	'$VER: Sound.s V1.01 (22.4.2001)',0
