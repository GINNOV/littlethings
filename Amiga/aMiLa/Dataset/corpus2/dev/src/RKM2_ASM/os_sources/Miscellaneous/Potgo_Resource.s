 ...
 * This example shows how you can use the potgo.resource to have two mice
 * running at the same time. Click on Mouse Button 2 (Middle or Right) of
 * the Mouse in gameport 1 (the joystick port). You can still use Mouse 1
 * as normal. This example checks for the potgo bits relating to Pins 9
 * and 5. For more info, read the appropriate amiga book/s and Include files.
...
POTBITS		EQU	OUTRY!DATRY!OUTRX!DATRX
...
zero_args
	...
	lea	potgo_name(pc),a1
	move.l	4.w,a6
	jsr	_LVOOpenResource(a6)
	move.l	d0,184(a4)
	beq	cl_icon

 * Allocate the bits for the right and middle mouse buttons, of gameport 1.
 ...
 * If the right or middle button was pressed you get a value of $1000/4096.
 * This value represents the bits I allocated. I.e you only check for the
 * bits you require.
...
cname		dc.b	'CON:0/0/640/180/ Potgo_Resource.s',0
potgo_name	dc.b	'potgo.resource',0,0
...
eol		dcb.b	1,10
	...
	dc.b	'$VER: Potgo_Resource.s V1.01 (22.4.2001)',0
