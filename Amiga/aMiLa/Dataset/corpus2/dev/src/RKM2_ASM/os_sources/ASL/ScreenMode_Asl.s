...
asl_load
	...
	move.l	156(a4),a1
	jsr	_LVOMove(a6)
	move.l	(a3),d1			; sm_DisplayID(a3),d1
...
asltags
	...
	dc.l	ASLSM_InitialTopEdge,0
	dc.l	ASLSM_InitialWidth,305
	dc.l	ASLSM_InitialHeight,255
	dc.l	ASLSM_InitialDisplayID,$8000
	dc.l	ASLSM_InitialDisplayWidth,640
	dc.l	ASLSM_InitialDisplayHeight,200
	dc.l	ASLSM_InitialDisplayDepth,2
	dc.l	ASLSM_InitialOverscanType,0
	dc.l	ASLSM_InitialAutoScroll,TRUE
	dc.l	ASLSM_TextAttr,topaz9
	dc.l	ASLSM_TitleText,asltitle
	dc.l	ASLSM_PositiveText,okstg
	dc.l	ASLSM_NegativeText,cancelstg
	dc.l	ASLSM_DoWidth,TRUE
	dc.l	ASLSM_DoHeight,TRUE
	dc.l	ASLSM_DoDepth,TRUE
	dc.l	ASLSM_DoOverscanType,TRUE
	dc.l	ASLSM_DoAutoScroll,TRUE

	dc.l	ASLSM_MinWidth,640
	dc.l	ASLSM_MaxWidth,1024
	dc.l	ASLSM_MinHeight,200
	dc.l	ASLSM_MaxHeight,512
	dc.l	ASLSM_MinDepth,1
	dc.l	ASLSM_MaxDepth,4

*	dc.l	ASLSM_Screen,scrnwndw
*	dc.l	ASLSM_Window,wndwptr
	dc.l	TAG_DONE
...
membuf		dcb.b	300,0
	...
	dc.b	'$VER: ScreenMode_ASL.s V1.01 (22.4.2001)',0
