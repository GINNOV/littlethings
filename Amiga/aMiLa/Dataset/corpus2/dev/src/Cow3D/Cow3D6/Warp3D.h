...
typedef struct
{
    ...
    W3D_Bool reserved2;
    ULONG mipmapmask ;    /* which mipmaps have to be generated */
    void *texsource ;     /* texture source image */
    void *mipmaps[16] ;   /* mipmap images */
    int texfmtsrc ;       /* texture format (from W3D_ATO_FORMAT) */
    ULONG *palette ;      /* texture palette for chunky textures */
...
typedef struct
{
    ...
    ULONG SCPMode;				/* Mode  and color format */
    ULONG SCPFlags;			/* Not used yet */
    /* Fog Coordinate Array */
    void *FogCoordPointer;		/* Array of fog coordinates */
    ULONG FCPMode;				/* Mode (double/float) of fog coordinates */
    ULONG FCPStride;			/* Stride of fog coord array */
    ULONG FCPFlags;			/* Flags, not yet used */
...
#define W3D_CHIP_NAPALM			9	/* Voodoo 4/5 */
#define W3D_CHIP_RADEON_R200	10	/* R200, R280, RV280 etc */
#define W3D_CHIP_RADEON_R300	11	/* R300, R350, R380, RV3xx etc */
...
#define W3D_R8G8B8A8           11       /* rrrrrrrr gggggggg bbbbbbbb
                                           aaaaaaaa */
#define W3D_COMPRESSED_R5G6B5  12		/* Compressed color, no alpha */
#define W3D_A4_COMPRESSED_R5G6B5 13		/* 4 bit alpha, compressed color */
#define W3D_COMPRESSED_A8R5G6B5 14		/* compressed alpha/color */
...
/* New states for V5 */
#define W3D_MULTITEXTURE		(1<<28)			/* Enable multitexturing and
												   separate blend functions */
#define W3D_FOG_COORD			(1<<29)			/* Use separate fog coord array
												   instead of first texture's
												   w coordinates */
...
#define W3D_Q_NUM_TMU			170		/* Number of texture units */
#define W3D_Q_NUM_BLEND			171		/* Number of blend stages */
#define W3D_Q_ENV_COMBINE		172		/* Supports env combine functions */
#define W3D_Q_ENV_ADD			173		/* Supports W3D_ADD environment */
#define W3D_Q_ENV_SUB			174		/* Supports W3D_SUB environment */
#define W3D_Q_ENV_CROSSBAR		175		/* Supports "crossbar" texture blending */
#define W3D_Q_STIPPLE_LINE 		176		/* Supports line stippling patterns */
#define W3D_Q_STIPPLE_POLYGON	177		/* Supports polygon stippling patterns */
...
#define W3D_ADD					5		/* Add texture and other color (either
                                           other texture unit, or fragment
                                           color) */
#define W3D_SUB					6		/* Subtract texture and other color) */
#define W3D_OFF					7		/* Turn off a texture unit */
...
#define W3D_ST_INCR_WRAP        7       /* increment with wrap */
#define W3D_ST_DECR_WRAP        8       /* decrement with wrap */
...
#define W3D_VFORMAT_FOG			(1<<0)	/* Fog coordinate (1 float) */
#define W3D_VFORMAT_COLOR		(1<<1)	/* primary color (4 floats RGBA) */
#define W3D_VFORMAT_PACK_COLOR	(1<<2)	/* primary color (1 ULONG RGBA) */
#define W3D_VFORMAT_SCOLOR		(1<<3)	/* secondary color (4 floats RGBA) */
#define W3D_VFORMAT_PACK_SCOLOR (1<<4)	/* secondary color (1 ULONG RGBA) */
#define W3D_VFORMAT_TCOORD_0	(1<<5)	/* texture coordinate sets
										   (3 floats per set, uvw) */
