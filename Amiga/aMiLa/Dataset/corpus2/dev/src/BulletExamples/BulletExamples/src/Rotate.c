...
static LONG table[TABLE_ENTRIES][2] =
{
     ...
     ULONG pointheight, ULONG xdpi, ULONG ydpi, ULONG unicode, ULONG unicode2)
{
  ...
  if (pointheight > 18000) pointheight = 18000;
  ...
  emheight = (pointheight * ydpi) / 7200; /* Calculate the pixel dimensions */
  emwidth  = (pointheight * xdpi) / 7200; /* of the EM square.              */
    ...
    {                                                  /* see the "Layers"      */
      ...
      {                                                /* RKRM: Libraries       */
        ...
        if (SetInfo(ge,
                ...
                OT_PointHeight, (pointheight << 16) / 100,   /* rotate and its   */
