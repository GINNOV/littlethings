...
{
  0, 11, 320, 120, 0, 1, 0, WFLG_DEPTHGADGET | WFLG_NOCAREREFRESH |
...
{
  320, 11, 320, 120, 0, 1, 0, WFLG_DEPTHGADGET | WFLG_NOCAREREFRESH |
...
{
  0, 131, 320, 120, 0, 1, 0, WFLG_DEPTHGADGET | WFLG_NOCAREREFRESH |
...
// front
  ...
  {
    Move(FrontRP, Points[Faces[i].Line1].x+160,
         65-(Points[Faces[i].Line1].y>>1));
    Draw(FrontRP, Points[Faces[i].Line2].x+160,
         65-(Points[Faces[i].Line2].y>>1));
    Draw(FrontRP, Points[Faces[i].Line3].x+160,
         65-(Points[Faces[i].Line3].y>>1));
    Draw(FrontRP, Points[Faces[i].Line1].x+160,
         65-(Points[Faces[i].Line1].y>>1));
  }

  Move(FrontRP, 152, 19);
  Text(FrontRP, "Up", 2);
  Move(FrontRP, 144, 115);
  Text(FrontRP, "Down", 4);
  Move(FrontRP, 274, 54);
...
// right
  ...
  for(i=0; i<(Mem3DDD->FacesNumber); i++)
  {
    Move(RightRP, 160-Points[Faces[i].Line1].z,
         65-(Points[Faces[i].Line1].y>>1));
    Draw(RightRP, 160-Points[Faces[i].Line2].z,
         65-(Points[Faces[i].Line2].y>>1));
    Draw(RightRP, 160-Points[Faces[i].Line3].z,
         65-(Points[Faces[i].Line3].y>>1));
    Draw(RightRP, 160-Points[Faces[i].Line1].z,
         65-(Points[Faces[i].Line1].y>>1));
  }

  Move(RightRP, 152, 19);
  Text(RightRP, "Up", 2);
  Move(RightRP, 144, 115);
  Text(RightRP, "Down", 4);
  Move(RightRP, 282, 54);
  Text(RightRP, "Back", 4);
  Move(RightRP, 6, 54);
...
// up
  ...
  for(i=0; i<(Mem3DDD->FacesNumber); i++)
  {
    Move(UpRP, Points[Faces[i].Line1].x+160,
         65+(Points[Faces[i].Line1].z>>1));
    Draw(UpRP, Points[Faces[i].Line2].x+160,
         65+(Points[Faces[i].Line2].z>>1));
    Draw(UpRP, Points[Faces[i].Line3].x+160,
         65+(Points[Faces[i].Line3].z>>1));
    Draw(UpRP, Points[Faces[i].Line1].x+160,
         65+(Points[Faces[i].Line1].z>>1));
  }
...
#define IND 2
  ...
  DOUBLE NorX, NorY, NorZ, NorLength;
    ...
    DrawEllipse(FrontRP, Points[Point2].x+160,
               65-(Points[Point2].y>>1), IND<<1, IND);
    SetAPen(FrontRP, Pen1);
    DrawEllipse(FrontRP, Points[Point1].x+160,
               65-(Points[Point1].y>>1), IND<<1, IND);
    SetAPen(FrontRP, Pen2);
    DrawEllipse(FrontRP, Points[Point3].x+160,
               65-(Points[Point3].y>>1), IND<<1, IND);
    SetAPen(FrontRP, Pen3);
    Move(FrontRP, Points[Point1].x+160,
               65-(Points[Point1].y>>1));
    Draw(FrontRP, nX+160, 65-(nY>>1));

    SetAPen(RightRP, Pen0);
    DrawEllipse(RightRP, 160-Points[Point2].z,
               65-(Points[Point2].y>>1), IND<<1, IND);
    SetAPen(RightRP, Pen1);
    DrawEllipse(RightRP, 160-Points[Point1].z,
               65-(Points[Point1].y>>1), IND<<1, IND);
    SetAPen(RightRP, Pen2);
    DrawEllipse(RightRP, 160-Points[Point3].z,
               65-(Points[Point3].y>>1), IND<<1, IND);
    SetAPen(RightRP, Pen3);
    Move(RightRP, 160-Points[Point1].z,
               65-(Points[Point1].y>>1));
    Draw(RightRP, 160-nZ, 65-(nY>>1));

    SetAPen(UpRP, Pen0);
    DrawEllipse(UpRP, Points[Point2].x+160,
         65+(Points[Point2].z>>1), IND<<1, IND);
    SetAPen(UpRP, Pen1);
    DrawEllipse(UpRP, Points[Point1].x+160,
         65+(Points[Point1].z>>1), IND<<1, IND);
    SetAPen(UpRP, Pen2);
    DrawEllipse(UpRP, Points[Point3].x+160,
         65+(Points[Point3].z>>1), IND<<1, IND);
    SetAPen(UpRP, Pen3);
    Move(UpRP, Points[Point1].x+160,
               65+(Points[Point1].z>>1));
    Draw(UpRP, nX+160, 65+(nZ>>1));
    ...
    SetAPen(FrontRP,0);
    RectFill(FrontRP, 4, 11, 315, 117);
    SetAPen(RightRP,0);
    RectFill(RightRP, 4, 11, 315, 117);
    SetAPen(UpRP,0);
    RectFill(UpRP, 4, 11, 315, 117);
