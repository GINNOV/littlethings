...
ULONG __saveds __stdargs L_OpenLibs(struct ExpatBase *ExpatBase);
...
#define EXLIBNAME "expat"
#define EXLIBVER  " 1.2 (9/9/02)"

char __aligned ExLibName [] = EXLIBNAME ".library";
char __aligned ExLibID   [] = EXLIBNAME EXLIBVER;
char __aligned Copyright [] = "Copyright (c) 1998, 1999, 2000 Thai Open Source Software Center Ltd";
...
ULONG __saveds __stdargs L_OpenLibs(struct ExpatBase *ExpatBase)
{
 ...
 ExpatBase->exb_IntuitionBase = IntuitionBase;

 ExpatBase->exb_GfxBase       = GfxBase;
