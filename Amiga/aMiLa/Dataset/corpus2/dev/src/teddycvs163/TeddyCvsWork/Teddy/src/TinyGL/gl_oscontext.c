...
ostgl_context *ostgl_create_context(
	...
	ostgl_context *context = (ostgl_context *)malloc( sizeof(ostgl_context) );
	int            i;
	ZBuffer       *zb;
	...
	assert( context );
	context->zbs          = (void**)malloc( sizeof(void*)*numbuffers );
	context->framebuffers = (void**)malloc( sizeof(void*)*numbuffers );
