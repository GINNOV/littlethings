...
/*!
	...
	\brief   Vertical docking component splitter
	\date    2001

*/


#ifndef TEDDY_PHYSICAL_COMPONENTS_V_SPLIT_H
#define TEDDY_PHYSICAL_COMPONENTS_V_SPLIT_H
...
class VSplit : public Area, public EventListener {
public:
	VSplit( const char *name, Area *target );
	virtual ~VSplit();
...
#endif  //  TEDDY_PHYSICAL_COMPONENTS_V_SPLIT_H
