...
/*!
	...
	\brief   Options object mix in
	\date    2001
*/


#ifndef TEDDY_MIX_IN_OPTIONS_H
#define TEDDY_MIX_IN_OPTIONS_H
...
public:
	...
	void          enableOptions   ( const unsigned long options );
	void          disableOptions  ( const unsigned long options );
