...
#include "SysSupport/Timer.h"  // sys_time  and sync
#include "Graphics/View.h"     // frame_age
...
Uint32 test_timer_callback( Uint32 interval, void *param ){
	TestManipulate *tester = (TestManipulate *)( param );	
	sys_time += frame_age = (float)(sync.Passed());
