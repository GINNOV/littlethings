...
#ifdef DEBUG
debug_printf("free_poly_list(%lx)\n", poly_list);
lsleep(1);
#endif DEBUG
...
{
#ifdef DEBUG
debug_printf("clone_n_link_rasters(%lx)\n", source);
lsleep(1);
#endif DEBUG
...
{
#ifdef DEBUG
debug_printf("free_n_unlink_rasters(%lx)\n", list);
lsleep(1);
#endif DEBUG
...
#ifdef DEBUG
debug_printf("rfree_s_sequence(%lx, %d)\n", ss, level);
lsleep(1);
#endif DEBUG
...
{
#ifdef DEBUG
debug_printf("free_s_sequence(%lx)\n", ss);
lsleep(1);
#endif DEBUG
...
{
#ifdef DEBUG
debug_printf("clone_s_sequence(%lx)\n", s);
lsleep(1);
#endif DEBUG
