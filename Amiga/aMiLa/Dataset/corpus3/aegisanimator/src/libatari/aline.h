...
struct aline {
    ...
    */
    ...
    int  colbit0;            /* color bit mask for plane 0 */
    int  colbit1;            /* color bit mask for plane 1 */
    int  colbit2;            /* color bit mask for plane 2 */
    int  colbit3;            /* color bit mask for plane 3 */
    int  lstlin;            /* -1 used in XOR mode */
    int  lnmask;            /* VDI line style */
    int  wmode;             /* VDI write mode */
    ...
    int  xmincl, ymincl;    /* clipping rectangle */
    int  xmaxcl, ymaxcl;
...
struct bbblock {
    int   b_wd;        /* width of bit block   */
    int   b_ht;       /* height of bit block  */
    int   plane_ct;   /* number of planes     */
    int   fg_col;
    int   bg_col;
    char  op_tab[4];
