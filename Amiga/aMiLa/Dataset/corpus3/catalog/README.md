...
This catalog makes `aMiLa/amiga_sources/` navigable for humans and data pipelines after cleanup and top-level normalization.
...
Keep `aMiLa/amiga_sources/catalog/` at the root. It should remain the source of truth for
