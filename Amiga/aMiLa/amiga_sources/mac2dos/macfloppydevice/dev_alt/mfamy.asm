...
* read from the floppy.  Checks headers and data for valid checksum errors, 
* moves data to the front of the buffer (following the track gap AAAA's) and 
* returns the first sector number of the buffer in D0.  Data in buffer still 
* is in MFM format (with embedded clock) but has been shifted to correct for 
* bit misalignment.
