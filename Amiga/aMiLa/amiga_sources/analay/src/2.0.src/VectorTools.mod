...
TYPE VectorObject * = POINTER TO VectorObjectDesc;
     VectorObjectDesc * = RECORD(l.NodeDesc)
       polies,
       lines  : l.List;
       locked : BOOLEAN;
       maxheight * ,
...
PROCEDURE NewVectorObject*():VectorObject;

VAR node : VectorObject;
...
PROCEDURE (obj:VectorObject) NewPolygon*(x1,y1,x2,y2,x3,y3:LONGREAL);
