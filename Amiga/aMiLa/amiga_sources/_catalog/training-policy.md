...
- large applications such as `MilkyTracker`, `yam`, `amiftp`, `ambermoon`
...
- broad disk-image or utility buckets such as `DISK` and `UTIL` until a human
  selects specific source files from them
...
Do not move source trees as part of data preparation. Use
