...
#ifdef DEBUG
debug_printf("cken_tweens(seq%lx)\n",ss);
#endif DEBUG
...
{
#ifdef DEBUG
debug_printf("cken_polys(seq%lx)\n",ss);
#endif DEBUG
...
{
#ifdef DEBUG
debug_printf("check_poly_list(%lx)\n",poly_list);
debug_printf("%lx->(%d %d %lx)\n", poly_list, poly_list->count, poly_list->alloc,
	poly_list->list);
#endif DEBUG
...
#ifdef DEBUG
debug_printf("cken_points( poly%lx )\n",poly);
debug_printf("pt_count %d pt_alloc %d\n",poly->pt_count, poly->pt_alloc);
#endif DEBUG
...
#ifdef DEBUG
debug_printf("copy_poly_list(%lx, %lx)\n",sp_list, dp_list);
#endif DEBUG
